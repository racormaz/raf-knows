    ...
    <div className="fixed z-10 w-full bg-gray-100">
      <div className="grid gap-3 relative py-4 lg:py-4">
        ...
        <div className="grid grid-cols-6">
          <div className="my-auto ml-8 col-span-full lg:col-span-1 flex space-x-6 place-items-center">
            <img className="h-8" src={RCM} alt="RCM Logo" />

            <div className="border-l-2 h-6 lg:h-10 border-gray-500 rounded"></div>
        ...
        <div className="fixed bottom-6 right-6 z-50 h-14 w-14">
          ...
          <button onClick={toggleNav} className="transition duration-200 ease-in-out h-14 w-14 transform active:translate-y-1 active:bg-blue-100 border-b-4 border-r-4 border-blue-500 shadow-xl lg:hidden rounded-full bg-blue-200 fixed bottom-6 right-6">
